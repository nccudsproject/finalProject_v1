...
public class TextProcess {
	...
	public void Process() {
		...
		while((indexOfOpen = content.indexOf("<",indexOfOpen))!=-1){
			...
			int indexOfClose = content.indexOf(">",indexOfOpen+1);//1.**here
			...
			if(tagName.equals("meta") || tagName.equals("!doctype")||tagName.equals("?xml")||tagName.equals("!DOCTYPE")||tagName.equals("link")
					||tagName.equals("!--[if link")||tagName.equals("![endif]--")||tagName.indexOf("!")!=-1||tagName.indexOf("@")!=-1) {
